	...
	return (
		<div className='bg-yellow-400 h-screen overflow-hidden flex items-center justify-center '>
			<div className='bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl rounded-xl	'>
				<div className='bg-gray-800 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 shadow-2xl '>
					<Link to='/'>
						<svg
							width='64'
							height='64'
				...
				<form className='p-14 md:p-16'>
					...
					<button className='bg-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded-md hover:bg-amber-400 hover:text-gray-900'>
						Регистрация
					</button>
