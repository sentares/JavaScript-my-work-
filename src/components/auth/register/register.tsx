...
export const Register: FC<IPropsRegister> = ({
	setEmail,
	setPassword,
	setUsername,
	setRepeatPassword,
	...
	return (
		<div className='bg-yellow-400 h-screen overflow-hidden flex items-center justify-center w-full '>
			<div className='bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl rounded-xl'>
				...
				<div className=' pr-16 pl-16 pt-16 pb-8'>
					...
					<button
						...
						role='button'
						className='focus:outline-none p-[14px] justify-center rounded-md border-none bg-gray-200 flex items-center w-full mt-5 hover:bg-amber-400 hover:ease-in duration-300 hover:text-gray-900'
					>
						<svg
							width='19'
							height='20'
					...
					<div className='flex items-center text-lg mt-5'>
						<p className=' m-auto'>
							Есть аккаунт?{' '}
							<Link className='text-amber-400 hover:text-amber-600' to='/login'>
								Войти
							</Link>
						</p>
					</div>
